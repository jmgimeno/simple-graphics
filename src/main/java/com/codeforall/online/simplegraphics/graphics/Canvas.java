...
public class Canvas {
    ...
    /**
     * Defines a limit to the width of the canvas
     * @param var0
     */
    public static void setMaxX(int var0) {
        MAX_X = var0;
    }

    /**
     * Defines a limit to the height of the canvas
     * @param var0
     */
    public static void setMaxY(int var0) {
        MAX_Y = var0;
    }
